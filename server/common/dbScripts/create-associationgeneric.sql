...
CREATE SCHEMA IF NOT EXISTS `asociatiegeneric` ;

USE `asociatiegeneric` ;

-- -----------------------------------------------------
-- Table `asociatiegeneric`.`apartment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`apartment` (
...
-- -----------------------------------------------------
-- Table `asociatiegeneric`.`user_has_apartment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`user_has_apartment` (
  ...
  CONSTRAINT `fk_user_has_apartment_apartment1`
    ...
    REFERENCES `asociatiegeneric`.`apartment` (`idapartment`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `asociatiegeneric`.`month`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`month` (
...
-- -----------------------------------------------------
-- Table `asociatiegeneric`.`meter`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`meter` (
...
-- -----------------------------------------------------
-- Table `asociatiegeneric`.`meter_index`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`meter_index` (
  ...
  CONSTRAINT `fk_meter_has_month_meter1`
    ...
    REFERENCES `asociatiegeneric`.`meter` (`idmeter`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_meter_has_month_month1`
    FOREIGN KEY (`month_idmonth`)
    REFERENCES `asociatiegeneric`.`month` (`idmonth`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `asociatiegeneric`.`apartments_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`apartments_group` (
...
-- -----------------------------------------------------
-- Table `asociatiegeneric`.`apartments_group_has_apartments_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`apartments_group_has_apartments_group` (
  ...
  CONSTRAINT `fk_apartments_group_has_apartments_group_apartments_group1`
    ...
    REFERENCES `asociatiegeneric`.`apartments_group` (`idapartments_group`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `asociatiegeneric`.`apartment_has_apartments_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `asociatiegeneric`.`apartment_has_apartments_group` (
  `apartment_idapartment` INT UNSIGNED NOT NULL,
  `apartments_group_idapartments_group` INT UNSIGNED NOT NULL,
