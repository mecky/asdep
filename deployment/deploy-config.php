 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/creatdenoi/asdep.git');
 ...
 */
define('TARGET_DIR', '/home/www/nginx/devasdep/asdep/');
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/home/www/tmp/devasdep-'.md5(REMOTE_REPOSITORY).'/');
